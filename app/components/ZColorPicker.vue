        ...
        <template #panel>
            <div class="p-2">
                <div class="grid grid-cols-5 gap-px">
                    <ZColorPickerPill v-for="color in primaryColors" :key="color.value" :color="color"
                ...
                <div class="grid grid-cols-5 gap-px">
                    <ZColorPickerPill v-for="color in grayColors" :key="color.value" :color="color" :selected="gray"
                        @select="gray = color" />
                </div>
            </div>
        </template>
